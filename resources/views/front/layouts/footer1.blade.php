        ...
        <div class="container">
            <div class="row align-items-center flex-lg-row flex-column-reverse pt-50 pb-40">
                <div class="col-lg-6">
                    ...
                    <form id="addEmail" action="{{ route('email.sub') }}" method="POST">
                        @csrf
                        <div class="email">
            ...
            <div class="col-md-4 mb-3 mb-md-0">
                <div class="social-media-links d-flex justify-content-center">
                    <a href="https://www.facebook.com/1XLUniverse"
                       style="color: #808080; text-decoration: none; transition: color 0.3s;"
                       target="_blank"
                    ...
                    <a href="https://www.linkedin.com/company/1XLUniverse"
                       target="_blank"
                       class="social-link text-decoration-none me-2"
                    ...
                    <a href="https://www.youtube.com/@1XLUniverse"
                       target="_blank"
                       class="social-link text-decoration-none me-2"
                       style="color: #808080; transition: color 0.3s;"
                    ...
                    <a href="https://www.medium.com/@1XLUniverse/"
                       target="_blank"
                       class="social-link text-decoration-none me-2"
                       style="color: #808080; transition: color 0.3s;"
                       onmouseover="this.style.color='#12100E'"
                       onmouseout="this.style.color='#808080'">
                        <i class="fab fa-medium"></i>
                    </a>

                    <a href="https://www.x.com/1XLUniverse/"
                       target="_blank"
                       class="social-link text-decoration-none me-2"
                       style="color: #808080; transition: color 0.3s;"
                    ...
                    <a href="https://www.reddit.com/user/1XLUniverse/"
                       target="_blank"
                       class="social-link text-decoration-none me-2"
                       style="color: #808080; transition: color 0.3s;"
                    ...
                    <a href="https://www.pinterest.com/1XLUniverse/"
                       target="_blank"
                       class="social-link text-decoration-none me-2"
                       style="color: #808080; transition: color 0.3s;"
                       onmouseover="this.style.color='#E60023'"
                       onmouseout="this.style.color='#808080'">
                        <i class="fab fa-pinterest"></i>
                    </a>

                    <a href="https://www.quora.com/profile/1XLUniverse/"
                       target="_blank"
                       class="social-link text-decoration-none me-2"
                       style="color: #808080; transition: color 0.3s;"
                       onmouseover="this.style.color='#B92B27'"
                       onmouseout="this.style.color='#808080'">
                        <i class="fab fa-quora"></i>
                    </a>

                    <a href="https://www.discord.com/channels/@1XLUniverse/"
                       target="_blank"
                       class="social-link text-decoration-none me-2"
                       style="color: #808080; transition: color 0.3s;"
                    ...
                    <a href="https://whatsapp.com/channel/0029VaLoJ1SLCoX4iyiW0R0c"
                       target="_blank"
                       class="social-link text-decoration-none me-2"
                       style="color: #808080; transition: color 0.3s;"
                    ...
                    <a href="https://www.threads.net/@1XLUniverse/"
                       target="_blank"
                       class="social-link text-decoration-none me-2"
                       style="color: #808080; transition: color 0.3s;"
                       onmouseover="this.style.color='#000000'"
