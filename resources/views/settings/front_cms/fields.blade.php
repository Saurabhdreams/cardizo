<div class="row">
    ...
    <div class="col-lg-12">
        <div class="mb-5">
            ...
            {{ Form::text('home_page_title', $setting['home_page_title'], ['class' => 'form-control', 'placeholder' => __('messages.front_cms.title'), 'required', 'maxlength'=>'100']) }}
        ...
        <div class="mb-5">
            ...
            {{ Form::text('sub_text', $setting['sub_text'], ['class' => 'form-control', 'id' => 'settingSubText','placeholder'=> __('messages.common.sub_text'),'required','maxlength'=>'200']) }}
        </div>
    </div>
    </div>
    <div class="col-lg-6">
