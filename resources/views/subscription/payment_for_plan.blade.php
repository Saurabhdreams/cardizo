                                ...
                                <div class="card h-100 p-5 me-2 shadow rounded">
                                    ...
                                    <div class="px-5 pb-5">
                                        ...
                                        <div class="d-flex align-items-center py-2 d-none">
                                            ...
                                            <span class="fs-5 w-50 text-muted fw-bold mt-1">
                                                <span
                                                    class="coupon-discount">{{ getCurrencyAmount($subscriptionsPricingPlan->price, $subscriptionsPricingPlan->currency->currency_icon) }}</span>
                                            </span>
                                        </div>
                                        <div class="d-flex align-items-center  py-2">
                                            <h4 class="fs-5 w-50 plan-data mb-0 me-5 fw-bolder">
                                        ...
                                        <div class="d-flex align-items-center  py-2">
                                            ...
                                            <span class="fs-5 w-50 text-muted fw-bold mt-1">
                                                <span
                                                    class="payable-amount">{{ getCurrencyAmount($newPlan['amountToPay'], $subscriptionsPricingPlan->currency->currency_icon) }}</span>
                                            </span>
                                        </div>
                                    </div>
                                </div>
