            ...
            <div class="modal-body">
                ...
                <div class="mb-3 form-group">
                    {{ Form::label('name', __('messages.common.name') . ' :', ['class' => 'form-label required']) }}
                     {{ Form::text('name', null, [
                        ...
                        'pattern' => '[A-Za-z]+',
                        'title' => __('The :attribute must contain only alphabetical characters.', ['attribute' => __('messages.form.enter_name')]),
                        'id' => 'paypalIntUserName'
                    ]) }} 
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                   ...
                   {{ Form::text('phone', null, [
                        ...
                        'pattern' => '[0-9+]+',
                        'title' => __('The :attribute must contain only numbers.', ['attribute' => __('messages.form.enter_phone')]),
                        'id' => 'paypalIntUserPhone'
                    ]) }}     
                </div>
                @if (isset($appointmentDetail->is_paid) &&
                    ...
                    @php
                        $translatedPaymentTypes1 = collect(\App\Models\Appointment::PAYMENT_METHOD)->map(function ($value) {
                    ...
                    <div class="mt-3">
                        ...
                        <input type="hidden" id="currencyCode" name="currency_code" value="{{ $currency->currency_code }}">
