        ...
        <div class="main-content mx-auto w-100 overflow-hidden">
            ...
            <div class="banner-section position-relative">
                <div class="banner-img">
                    ...
                    <video class="cover-video w-100 h-100 object-fit-cover" loop autoplay muted  alt="background video" id="cover-video">
                                ...
                                <div class="">
                                    ...
                                    <div class="product-card card">
                                        <div class="product-img card-img">
                                            <img src="{{ $product->product_icon }}" class="img-fluid h-100" loading="lazy"/>
                                        </div>
            ...
            <div class="my-5">
                ...
                <nav>
                    ...
                    <div class="nav nav-tabs px-0 border-0" id="nav-tab" role="tablist">
                        <button class="py-2 active postbtn instagram-btn text-dark border-0" id="nav-home-tab"
                            data-bs-toggle="tab" data-bs-target="#nav-home" type="button" role="tab"
                            aria-controls="nav-home" aria-selected="true">
                            <span class="px-1">{{ __('messages.vcard.post') }}</span></button>
                        <button class="py-2 instagram-btn reelsbtn text-dark border-0" id="nav-profile-tab"
...
<div class="col-12">
    <input type="text" name="name" class="form-control" placeholder="{{ __('messages.form.your_name') }}" pattern="[A-Za-z\s]+" title="Please enter your name using only alphabetical characters." required />
</div>                           
<div class="col-12">
								<input type="tel" name="phone" class="form-control" placeholder="{{ __('messages.form.phone') }}"  pattern="[0-9+]*" title="{{ __('The :attribute must contain only numbers.', ['attribute' => __('messages.form.phone')]) }}" required />
							</div>
                            
<div class="col-12">
    <input type="email" name="email" class="form-control" placeholder="{{ __('messages.form.your_email') }}" title="Please enter valid email" required />
</div>
<div class="col-12">
    <textarea class="form-control h-100" name="message" placeholder="{{ __('messages.form.type_message') }}" rows="3" required></textarea>
</div>
