    ...
    <div class="container p-0 vcard22-main">
        <div class="main-content mx-auto w-100 overflow-hidden bg-green">
            ...
            <div class="profile-section mb-5 px-30">
                ...
                <p class="text-gray-100 profile-desc mb-30 fs-14 text-sm-start text-center">
                ...
                <div class="social-media-section">
                    <div class="d-flex justify-content-sm-start justify-content-center">
                        @if (checkFeature('social_links') && getSocialLink($vcard))
                            <div
                                class="social-icons d-flex justify-content-center text-decoration-none flex-wrap text-light bg-gray-100 rounded-pill">
                ...
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section mb-5 pb-3 px-30">
                        ...
                        <div class="appointment">
                            <div class="mb-30">
                                <label for="date"
                                    class="appoint-date text-white fs-18 mb-1">{{ __('messages.date') }}</label>
                                <div class="row">
                                    <div class="col-12">
                            ...
                            <div class="">
                                <label class="appoint-hour fs-18 mb-10">{{ __('messages.hour') }}</label>
                                <div class="row mb-3">
                                    <div class="">
                                ...
                                <div class="text-center">
                                    <button type="submit" class="appointmentAdd btn btn-primary w-100">
            ...
            @if ((isset($managesection) && $managesection['insta_embed']) || empty($managesection))
                @if (checkFeature('instagramEmbed') && $vcard->instagramEmbed->count())
                    <div class="">
                        <div class="section-heading px-3 ms-3">
                        ...
                        <nav>
                            <div class="row insta-toggle">
                                <div class="nav nav-tabs border-0 px-0" id="nav-tab" role="tablist">
                                    ...
                                    <button class="py-2 instagram-btn reelsbtn  border-0 text-light mr-0"
            ...
            @if ((isset($managesection) && $managesection['iframe']) || empty($managesection))
                @if (checkFeature('iframes') && $vcard->iframes->count())
                    <div class="blog-section mb-5 pb-3">
                        <div class="section-heading iframe-head">
       ...
       title="{{ __('The :attribute must contain only numbers.', ['attribute' => __('messages.form.phone')]) }}" />
                                ...
                                <div class="col-12 text-center mb-3">
                                    <button class="contact-btn send-btn rounded btn btn-primary" type="submit">
            ...
            @if (!isset($userSetting['enable_contact']) || (!$userSetting['enable_contact'] && $userSetting['enable_contact'] != 0) || $userSetting['enable_contact'] == 1)
                <div class="add-to-contact-section pb-50 mb-3">
                    <div class="text-center">
                ...
                <div class="fixed-btn-section">
                    ...
                    <div class="sub-btn d-none">
                        <div
                            ...
                            @if (empty($userSetting['hide_stickybar']))
                                <div
                                    class="{{ isset($userSetting['whatsapp_share']) && $userSetting['whatsapp_share'] == 1 ? 'vcard22-btn-group' : 'stickyIcon' }}">
                                    <button type="button"
                    ...
                    <div class="mb-10 mt-0">
                        <div class="support-banner d-flex align-items-center justify-content-center">
                            ...
                            <div class="">
                                ...
                                <div class="text-center">
                                    <a href="{{ $banners->url }}" class="act-now rounded text-dark" target="blank"
