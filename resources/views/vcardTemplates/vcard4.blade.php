    ...
    <div class="container p-0">
        ...
        <div class="main-content vcard w-100 mx-auto content-blur collapse show allSection">
            ...
            <div class="vcard__banner w-100 position-relative">
                ...
                <video class="cover-video banner-image" loop autoplay muted  alt="background video" id="cover-video">
            ...
            <nav>
                ...
                <div class="nav nav-tabs px-0" id="nav-tab" role="tablist">
                    ...
                    <button class="instagram-btn reelsbtn fs-2 border-0 py-2" id="nav-profile-tab" data-bs-toggle="tab"
