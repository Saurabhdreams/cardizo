        ...
        <div class="vcard-fifteen main-content mx-auto w-100 overflow-hidden">
                    ...
                    <div class="support-banner d-flex align-items-center justify-content-center">
                        ...
                        <div class="">
                            ...
                            <div class="text-center">
                                <a href="{{ $banners->url }}" class="act-now rounded mb-4" target="blank" data-turbo="false">{{ $banners->banner_button }}</a>
                            </div>
                        </div>
                    </div>
                @endif
            ...
            <div class="blog-section pt-40 bg-gray-200">
                ...
                <div class="nav nav-tabs border-0 px-0" id="nav-tab" role="tablist">
                    ...
                    <button class="py-2 instagram-btn reelsbtn border-0 text-dark" id="nav-profile-tab" data-bs-toggle="tab"
