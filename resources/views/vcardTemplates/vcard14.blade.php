    ...
    <div class="container p-0">
            ...
            <div class="profile-section px-30">
                <div class="card flex-sm-row align-items-center mb-40">
                    <div class="card-img me-sm-3">
                        <img src="{{ $vcard->profile_url }}" class="img-fluid rounded-circle h-100 w-100" loading="lazy"/>
                    </div>
                                            ...
                                            <div class="card-img d-flex justify-content-center align-items-center">
                                                ...
                                                <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                                                    ...
                                                    <img src="{{ $service->service_icon }}"
                                                        alt="{{ $service->name }}" height="28" width="36" loading="lazy">
                                                </a>
                                            </div>
                                        ...
                                        <div class="">
                                            <div class="product-card card">
                                                <div class="product-img card-img">
                                                    <img src="{{ $product->product_icon }}" loading="lazy"/>
                                                </div>
                                    ...
                                    <div class="blog-card">
                                        <div class="card-img">
                                            <a href="{{ route('vcard.show-blog', [$vcard->url_alias, $blog->id]) }}">
                                                <img src="{{ $blog->blog_icon }}" alt="profile" class="w-100" loading="lazy"/>
                                            </a>
                                        </div>
                                        <div class="card-body">
       ...
       title="{{ __('The :attribute must contain only numbers.', ['attribute' => __('messages.form.phone')]) }}" />
                                ...
                                <div class="col-12 d-flex justify-content-center mt-4 pb-2">
                                    <button class="contact-btn btn btn-gradient rounded-2 d-flex align-items-center mb-4"
                                        type="submit">
