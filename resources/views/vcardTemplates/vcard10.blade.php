                                ...
                                @foreach ($vcard->testimonials as $testimonial)
                                    <div class="col-12 h-100">
                                        <div
                                            ...
                                            <div
                                                class="testimonial-user mt-auto d-flex flex-sm-row flex-column align-items-center justify-content-sm-start justify-content-center">
                    ...
                    <nav>
                        <div class="row insta-toggle">
                            <div class="nav nav-tabs px-0" id="nav-tab" role="tablist">
                                <button class="py-0 active postbtn instagram-btn fs-2 border-0" id="nav-home-tab"
                                    data-bs-toggle="tab" data-bs-target="#nav-home" type="button" role="tab"
                                    aria-controls="nav-home" aria-selected="true">
                                    <span class="px-1">{{ __('messages.vcard.post') }}</span></button>
                                <button class="py-2 instagram-btn reelsbtn fs-2 border-0" id="nav-profile-tab"
                ...
                <div class="vcard-bars-btn position-relative">
                    ...
                    <div class="sub-btn d-none">
                        <div class="sub-btn-div">
                            ...
                            @if (empty($userSetting['hide_stickybar']))
                                <div
                                    class="{{ isset($userSetting['whatsapp_share']) && $userSetting['whatsapp_share'] == 1 ? 'vcard10-btn-group' : 'stickyIcon' }}">
                                    <button type="button"
