            ...
            <div class="banner-section position-relative">
                <div class="banner-img">
                    @if (strpos($vcard->cover_url, '.mp4') !== false ||
                        ...
                        <video class="cover-video object-fit-cover w-100 h-100" loop autoplay muted
                        ...
                        <form action="" id="enquiryForm">
                            ...
                            <div class="mb-10">
                                <input type="text" class="form-control"
                                    placeholder="{{ __('messages.form.your_name') }}" name="name" pattern="[A-Za-z]+"
       title="{{ __('The :attribute must contain only alphabetical characters.', ['attribute' => __('messages.form.your_name')]) }}"  />
                            ...
                            <div class="mb-10">
                                <input type="tel" class="form-control"
                                    placeholder="{{ __('messages.form.phone') }}" name="phone"  pattern="[0-9+]*"
            ...
            <div class="btn-section cursor-pointer">
                <div class="fixed-btn-section">
                    @if (empty($userSetting['hide_stickybar']))
                        <div class="bars-btn retail-bars-btn">
                    ...
                    <div class="sub-btn d-none">
                        <div class="sub-btn-div">
                            ...
                            @if (empty($userSetting['hide_stickybar']))
                                <div
                                    class="{{ isset($userSetting['whatsapp_share']) && $userSetting['whatsapp_share'] == 1 ? 'vcard21-btn-group' : 'stickyIcon' }}">
                                    <button type="button"
