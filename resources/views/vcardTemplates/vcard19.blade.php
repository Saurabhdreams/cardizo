...
<body>
    <div class="container p-0">
                ...
                <div class="mt-5 px-40">
                    ...
                    <nav>
                        ...
                        <div class="nav nav-tabs border-0 px-0" id="nav-tab" role="tablist">
                            ...
                            <button class="py-2 instagram-btn reelsbtn border-0 text-dark" id="nav-profile-tab"
       ...
       pattern="[0-9+]*" title="{{ __('The :attribute must contain only numbers and the.', ['attribute' => __('messages.form.phone')]) }}" />
