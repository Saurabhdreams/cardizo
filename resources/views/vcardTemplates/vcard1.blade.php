    ...
    <div class="container p-0">
        ...
        <div class="vcard-one main-content  w-100 mx-auto content-blur allSection collapse show">
            ...
            <div class="vcard-one__banner w-100 position-relative">
                ...
                <video class="cover-video" loop autoplay muted  alt="background video" id="cover-video">
                        ...
                        <nav>
                            <div class="row insta-toggle">
                                <div class="nav nav-tabs px-0" id="nav-tab" role="tablist">
                                    <button class="active postbtn instagram-btn fs-2 text-dark py-2" id="nav-home-tab"
                                        data-bs-toggle="tab" data-bs-target="#nav-home" type="button"
                                        role="tab" aria-controls="nav-home" aria-selected="true">
                                        <span class="px-1">{{ __('messages.vcard.post') }}</span></button>
                                    <button class="instagram-btn reelsbtn fs-2 text-dark py-2" id="nav-profile-tab"
                        ...
                        <div class="container">
                            <div class="row g-3 mb-0 justify-content-center blog-slider overflow-hidden">
                                @foreach ($vcard->blogs as $blog)
                                    <div class="col-6 mb-2">
                                        <div
                                            class="card blog-card p-sm-2 p-4 border-0 w-100 h-100 flex-sm-row flex-column d-flex align-items-center">
            ...
            @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
                @if ($vcard->businessHours->count())
                    ...
                    @endphp
                    <div class="vcard-one__timing py-3 px-1 mt-0">
                ...
                <div class="vcard-bars-btn position-relative">
                    ...
                    <div class="sub-btn d-none">
                        <div class="sub-btn-div">
                            ...
                            @if (empty($userSetting['hide_stickybar']))
                                <div
                                    class="{{ isset($userSetting['whatsapp_share']) && $userSetting['whatsapp_share'] == 1 ? 'vcard1-btn-group' : 'stickyIcon' }}">
                                    <button type="button"
