    ...
    <div class="container p-0">
        ...
        <div class="vcard-two main-content w-100 mx-auto overflow-hidden content-blur collapse show allSection">
            ...
            <div class="vcard-two__banner w-100 position-relative">
                ...
                <video class="cover-video img-fluid banner-image position-relative" loop autoplay muted  alt="background video" id="cover-video">
            ...
            @if ((isset($managesection) && $managesection['contact_list']) || empty($managesection))
                <div class="vcard-two__event py-3 px-3 ms-3">
                    @if ($vcard->email)
                        <div class="event-details d-flex">
                            <div class="event-image">
                                <img src="{{ asset('img/vcard2/vcard2-email.png') }}" alt="email"
                                    class="" />
                            </div>
                    ...
                    @if ($vcard->alternative_phone)
                        <div class="event-details d-flex">
                            <div class="event-image">
                                <img src="{{ asset('/img/vcard2/old-typical-phonevcard2.png') }}" height="23px"
            ...
            <nav>
                ...
                <div class="nav nav-tabs px-0" id="nav-tab" role="tablist">
                    <button class="active postbtn instagram-btn fs-2 text-decoration-none py-2" id="nav-home-tab"
                        data-bs-toggle="tab" data-bs-target="#nav-home" type="button" role="tab"
                        aria-controls="nav-home" aria-selected="true">
                        <span class="px-1">{{ __('messages.vcard.post') }}</span></button>
                    <button class="instagram-btn reelsbtn fs-2 text-decoration-none py-2" id="nav-profile-tab" data-bs-toggle="tab"
       ...
       title="{{ __('The :attribute must contain only alphabetical characters.', ['attribute' => __('messages.form.your_name')]) }}">
                                            ...
                                            <div class="mb-3">
                                                <input type="tel" name="phone" class="form-control"
                                                    id="phone"
                                                    placeholder="{{ __('messages.form.enter_phone') }}"  pattern="[0-9+]*"
       title="{{ __('The :attribute must contain only numbers.', ['attribute' => __('messages.form.phone')]) }}" >
                                            ...
                                            @if (!empty($vcard->privacy_policy) || !empty($vcard->term_condition))
                                                <div class="form-check form-check position-absolute">
