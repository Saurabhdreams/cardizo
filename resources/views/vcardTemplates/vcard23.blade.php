        ...
        <div class="main-content mx-auto w-100 overflow-hidden">
           ...
           @endif
            ...
            @if ((isset($managesection) && $managesection['contact_list']) || empty($managesection))
                <div class="contact-section mx-md-3 px-40 mb-5">
                    <div class="row">
                        @if ($vcard->email)
                                ...
                                @foreach ($vcard->services as $service)
                                    <div class="col-sm-6 mb-sm-2 mb-5 mt-5 px-sm-3">
                                        <div class="service-card h-100">
                                            <div
                                                class="card-img mx-auto d-flex justify-content-center mb-3">
                                        ...
                                        <div class="gallery-img">
                                            ...
                                            @elseif($file->type == App\Models\Gallery::TYPE_FILE)
                                                <a id="file_url" href="{{ $file->gallery_image }}"
                                                    class="gallery-link gallery-file-link w-100 h-100 d-block" target="_blank" loading="lazy">
                                ...
                                <div class="testimonial-card card">
                                    ...
                                    <div class="card-body p-0 pt-3">
                                        <div class="text-center">
                                            <h3 class="text-primary fs-20 mb-0"> {{ ucwords($testimonial->name) }}</h3>
                                            <p
