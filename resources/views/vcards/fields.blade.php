...
@if ($partName == 'basics')
    ...
    <div class="row" id="basic">
            ...
            <div class="d-sm-flex">
                <div class="input-group">
                     {{ Form::text('url_alias', isset($vcard) ? $vcard->url_alias : null, [
                        ...
                        'pattern' => '[A-Za-z0-9\-]+',
                        'title' => __('The :attribute must contain only letters, numbers, and hyphens.', ['attribute' => __('messages.form.my_vcard_url')])
                    ]) }} 
        ...
        <div class="col-lg-6 mb-7">
            ...
            {{ Form::text('name', isset($vcard) ? $vcard->name : null, ['class' => 'form-control', 'placeholder' => __('messages.form.vcard_name'), 'required','pattern' => '[A-Za-z\ ]+', 'title' => __('The :attribute must contain only alphabetical characters.')]) }}
        </div>
        <div class="col-lg-6 mb-7">
            {{ Form::label('occupation', __('messages.vcard.occupation') . ':', ['class' => 'form-label']) }}
            {{ Form::text('occupation', isset($vcard) ? $vcard->occupation : null, ['class' => 'form-control', 'placeholder' => __('messages.form.occupation'),'pattern' => '[A-Za-z]+', 'title' => __('The :attribute must contain only alphabetical characters.')]) }}
        </div>
        <div class="col-lg-6 mb-7">
            <div class="mb-5">
            ...
            <div class="mt-5 row">
                ...
                <div class="col-md-6">
                    <div class="form-group mb-7">
                        ...
                        {{ Form::text('first_name', isset($vcard) ? $vcard->first_name : null, ['class' => 'form-control', 'placeholder' => __('messages.form.f_name'), 'required', 'pattern' => '[A-Za-z]+', 'title' => __('The :attribute must contain only alphabetical characters.')]) }}
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group mb-7">
                        {{ Form::label('last_name', __('messages.vcard.last_name') . ':', ['class' => 'form-label required']) }}
                        {{ Form::text('last_name', isset($vcard) ? $vcard->last_name : null, ['class' => 'form-control', 'placeholder' => __('messages.form.l_name'), 'required', 'pattern' => '[A-Za-z]+', 'title' => __('The :attribute must contain only alphabetical characters.')]) }}
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group mb-7">
                ...
                <div class="col-lg-6 mb-7">
                    ...
                    {{ Form::text('dob', isset($vcard) ? $vcard->dob : null, ['class' => 'form-control bg-white', 'placeholder' => __('messages.form.DOB'), 'pattern' => '(0[1-9]|[12][0-9]|3[01])/(0[1-9]|1[0-2])/(19|20)\d{2}', 'title' => __('The :attribute must be in the format DD/MM/YYYY and contain only numeric characters.')]) }}
                </div>
                <div class="col-lg-6 mb-7">
                    ...
                    <div class="col text-md-start text-center">
                        ...
                        <div class="col">
                            <label class="button-label mx-2 mb-3">
                                <input type="radio" name="sticky_bar" class="sticky-btn"
